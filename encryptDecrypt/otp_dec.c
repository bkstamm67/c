 ...
 * Author:  Brian Stamm
 * Date:  8.14.15
 * Description:  This program connects to its sister program and decodes a string
 ...
 * Notes:  None.
 * Citation:  Most of the citation is done in otp_dec_d.c, but the code for the sockets
...
int main(int argc, char **argv){
   ...
   //Sister file only connects with program sending @ in header.  # separates values
   ...
   fprintf(stdout, "%s\n", finalSet);	//Prints out decoded string.
